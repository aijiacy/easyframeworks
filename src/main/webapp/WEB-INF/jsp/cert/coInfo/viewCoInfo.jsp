				...
				<tr>
					<td><div class="input-group">
							<span class="input-group-addon">企业名称</span><input name="co_name"
								type="text" value="${coinfo.pe_name }" class="form-control" placeholder="企业名称" required
								autofocus />
						</div></td>
					<td><div class="input-group">
							<span class="input-group-addon">组织机构代码</span><input
								name="co_org_name" type="text"   value="${coinfo.pe_org_code }"
								class="form-control"
				...
				<tr>
					<td><div class="input-group">
							<span class="input-group-addon">注册地址</span><input
								name="co_reg_addr" type="text" value="${coinfo.pe_org_code }"  class="form-control"
