...
/**
 * @class: MD5CalcUtils
 * @description : MD5 原型C++的算法
 * @author CaoYong
 * @date 2014年5月2日 上午2:12:26
 */
public class MD5CalcUtils {
    ...
    /**
     * default Construct. Standard JavaBean
     */
    public MD5CalcUtils() {
        md5Init();
        return;
     ...
     * @param inbuf
     * @return 返回之是变换完之结果，这个结果是从公共成员digestHexStr取得之．
     */
    ...
    private void md5Init() {
        count[0] = 0L;
        count[1] = 0L;
        ///* Load magic initialization constants. 初始化幻数
        state[0] = 0x67452301L;
        state[1] = 0xefcdab89L;
        state[2] = 0x98badcfeL;
        state[3] = 0x10325476L;
...
//        Md5Prototype md5 = new Md5Prototype();
//        System.out.println(md5.getMD5ofStr("111"));
//    }
}